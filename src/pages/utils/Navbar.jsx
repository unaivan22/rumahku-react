    ...
    <div className="navbar sticky top-0 bg-base-100 py-4 border-b border-zinc-100">
        <div className='container flex justify-between'>
            <div className="navbar-">
                <Link to='/' className="pointer sm:hidden xs:hidden xl:block font-semibold text-xl"><span className='text-zinc-900'>Rumah</span><span className='text-rose-500'>ku</span></Link>
